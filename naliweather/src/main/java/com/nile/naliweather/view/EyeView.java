...
public class EyeView extends ImageView {
    ...
    public Bitmap getBitmap() {
        ...
        Bitmap origin2 = null;
        if (progress >= 1.0) {
            BitmapDrawable drawable1 = (BitmapDrawable) this.getResources().getDrawable(R.mipmap.eye_light1);
            origin1 = drawable1.getBitmap();
            BitmapDrawable drawable2 = (BitmapDrawable) this.getResources().getDrawable(R.mipmap.eye_light2);
            origin2 = drawable2.getBitmap();
        } else {
            BitmapDrawable drawable1 = (BitmapDrawable) this.getResources().getDrawable(R.mipmap.eye_gray_1);
            origin1 = drawable1.getBitmap();
            BitmapDrawable drawable2 = (BitmapDrawable) this.getResources().getDrawable(R.mipmap.eye_gray_2);
            origin2 = drawable2.getBitmap();
        }
